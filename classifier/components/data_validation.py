...
class DataValidation:
    ...
    def initiate_data_validation(self)->artifact_entity.DataValidationArtifact:
        try:
            ...
            base_df = utils.convert_columns_category(df=base_df, exclude_columns=exclude_columns)
            train_df = utils.convert_columns_category(df=train_df, exclude_columns=exclude_columns)
            test_df = utils.convert_columns_category(df=test_df, exclude_columns=exclude_columns)
